...
const Header = ({type}) => {
    ...
    const handleOption = (name, action) => {
        ...
        setOptions((prev) => {
            return {
                ...prev,
                [name]: action === "i" ? options[name] + 1 : options[name] > 1 ? options[name] - 1 : options[name],
    ...
    return (
        ...
        <div className="header">
            <div className={type === "list" ? "headerContainer listMode" : "headerContainer"}>
                ...
                <p className="headerDesc">tourist stickers stock photos, vectors, and illustrations are available royalty-free. See tourist stickers stock video clips.</p>
